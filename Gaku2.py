...
for xcTeam in range(1000):
	rr = random.randint
	rc = random.choice
	ngentot1 = f"Dalvik/2.1.0 (Linux; U; Android 5.1.1; LG-D855 Build/LMY48G.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.orca;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/LG-D855;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
	if ngentot1 in ngentott:pass
	else:ngentott.append(ngentot1)
	ngentot2 = f"Dalvik/2.1.0 (Linux; U; Android 8.0.0; OnePlus 3 Build/ABCDEF.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{str(rr(200000000,299999999))};FBCR/IndosatOoredoo;FBMF/Realme;FBBD/Realme;FBDV/AEOBC;FBSV/9;FBCA/arm64-v8a:null;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
	if ngentot2 in ngentott:pass
	else:ngentott.append(ngentot2)
	ngentot3 = f"Dalvik/2.1.0 (Linux; U; Android 9.0.0; YAL-L41 Build/HUAWEIYAL-L41.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.orca;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/YAL-L41;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
	if ngentot3 in ngentott:pass
	else:ngentott.append(ngentot3)
	ngentot4 = f"Dalvik/2.1.0 (Linux; U; Android 8.0; AERIAL Build/MRA58K.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{str(rr(200000000,299999999))};FBCR/IndosatOoredoo;FBMF/Realme;FBBD/Realme;FBDV/AERIAL;FBSV/9;FBCA/arm64-v8a:null;FBDM/"+"(density=2.0,width=720,height=1412};]"
